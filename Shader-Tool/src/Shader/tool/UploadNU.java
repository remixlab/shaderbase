...
class UploadNU{
	...
	public UploadNU(final Editor editor, final Path pathos, JPanel card2, String[] listadata, boolean updatecheck) throws IOException, TransportException, GitAPIException
	{
        ...
        commitb.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent a) {
            	 ...
            	 if(a1.contains("Name your shader")||b1.contains("Write some tags about your shader")||c1.contains("Write a small description")
            		 ...
            		 JOptionPane.showMessageDialog(null,
            				     "Please fill the form only takes few minutes"
            				 , //Mensaje
       ...
       //PDE CHECK
		...
		int selectedOption1 = JOptionPane.showConfirmDialog(null, 
                "Do you want to upload the shader?? (it will be uploaded after next update)", 
                "Choose", 
