...
class Search {
	...
	public Search(String[] searchid2, String[] searchnames2, Editor editor, Path pathos, String[] searchfolder2, String searchin2) throws ParseException {
		...
		// 3. query
		    ...
		    Query q = new QueryParser(Version.LUCENE_47, "contents", analyzer).parse(querystr);
