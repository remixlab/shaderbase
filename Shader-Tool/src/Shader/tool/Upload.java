  ...
  public Upload(final Editor editor, final Path pathos, JPanel card2,
    ...
    noimg.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        if (noimg.isSelected() == true) {
          ...
          JOptionPane.showMessageDialog(null, "Using default image", // Mensaje
              "Default Image", // T�tulo
    ...
    imgb.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        FileFilter imageFilter = new FileNameExtensionFilter("JPG Files", "jpg");
      ...
      public void actionPerformed(ActionEvent a) {
        ...
        if (a1.contains("Name your shader")
          ...
          JOptionPane.showMessageDialog(null, "Please fill the form, \n"
              + "it will take few minutes", // Mensaje
              "Fill the form", // Title
          ...
          if (selectedOption1 == JOptionPane.YES_OPTION) {
            ...
            if (Arrays.asList(allnames).contains(a1)) {
              ...
              if (selectedOptionB == JOptionPane.YES_OPTION) {
                ...
                try {
                  ...
                  /*
                   * try { git.rm().addFilepattern("ShaderData/"+a1+"/"+
                   * a1+".pde") .call(); } catch (NoFilepatternException e1) {
                   * // TODO Auto-generated catch block e1.printStackTrace(); }
                   * catch (GitAPIException e1) { // TODO Auto-generated catch
            ...
            if (checkname == true) {
              ...
              if (pdecode.contains("PShader")) {
                ...
                PrintWriter writer;
                try {
                  writer = new PrintWriter(repo + "/ShaderData/" + a1 + "/"
                      + a1 + ".txt", "UTF-8");
                ...
                if (dirdatainfo == null) {
                  JOptionPane.showMessageDialog(null,
                      ...
                      "No files in data folder", // T�tulo
                      JOptionPane.WARNING_MESSAGE); // Tipo de mensaje
                  try {
                ...
                File imgfinal = new File(repo + "/ShaderData/" + a1 + "/" + a1
                    + ".jpg");
                try {
                ...
                try {
                  ...
                  // File myfile = new File(dir+"/ShaderData/folder_prueba",
                  // "shaderfile.glsl");
                  // try {
            ...
            if (checklocal == true) {
              ...
              PrintWriter writer;
              try {
                writer = new PrintWriter(repo + "/ShaderData/" + a1 + "/" + a1
                    + ".txt", "UTF-8");
              ...
              String[] dirdatainfo = dirdata.list();
              if (dirdatainfo == null) {
                JOptionPane.showMessageDialog(null, "The data folder is empty", // Mensaje
                    "No files in data folder", // T�tulo
                    JOptionPane.WARNING_MESSAGE); // Tipo de mensaje
                try {
                  throw new Exception("Data Folder empty");
